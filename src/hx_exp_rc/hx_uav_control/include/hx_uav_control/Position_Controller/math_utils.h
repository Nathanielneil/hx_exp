#ifndef HX_MATH_UTILS_H
#define HX_MATH_UTILS_H
...
// Create quaternion from (roll,pitch,yaw) by a 3-2-1 intrinsic Tait-Bryan rotation sequence
...
// Convert quaternion to (roll,pitch,yaw) by a 3-2-1 intrinsic Tait-Bryan rotation sequence
...
// Constrain function with symmetric limits
...
// Constrain function with asymmetric limits
float constrain_function(float data, float Min, float Max)
{
    if(data > Max)
    {
        return Max;
