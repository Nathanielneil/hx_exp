...
# HX ROS-AirSim Environment Startup Script

echo "Starting HX ROS-AirSim Environment..."
...
echo "Copying HX ROS AirSim settings..."
...
echo "Launching HX ROS-AirSim Blocks Environment..."
